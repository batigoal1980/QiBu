	...
	<tr>
		...
		<BR />
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td class="pagetitle" align="left" style="padding-left:15px" height="25" align="center">Reports Manager </td>
				</tr>
			</table>
			</td>
		</tr>
		...
		<tr>
			...
			<table border="0" cellpadding="1" cellspacing="1" width="95%">
				<tr>
					...
					<td class="headTitle" width="15%">Page Address</td>
   					<td class="headTitle" width="20%">Problem</td>
					<td class="headTitle" width="20%">Your email</td>
					<td class="headTitle" width="25%">Action</td>
				</tr>
				<script>
					function suredelete()
					{
						if (confirm("You sure want to delete this report? \n This action can't be undone."))
							return true;
						else
							return false;
					}
				...
				<?php
					$lists=abuselisting();
					if ($lists=="")
						echo "<td colspan='3' align='left'> No Abuses</td>";
					else
						echo $lists;
				?>
			</table>
