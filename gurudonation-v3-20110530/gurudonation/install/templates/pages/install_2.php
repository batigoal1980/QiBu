...
<div class="contentBlock">
  <div class="infoPane">
    ...
    <div class="infoPaneContents">
      <p>The web server takes care of serving the pages of your donation site to your guests and customers. The web server parameters make sure the links to the pages point to the correct location.</p>
    </div>
  </div>
  ...
  <div class="contentPane">
    ...
    <table border="0" width="99%" cellspacing="0" cellpadding="5" class="inputForm">
      <tr>
        ...
        <td class="inputDescription">The web address to the auction store.</td>
      </tr>
      <tr>
        ...
        <td class="inputDescription">The directory where the auction store is installed on the server.</td>
      </tr>
    </table>
