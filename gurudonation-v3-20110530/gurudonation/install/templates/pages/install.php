...
<div class="contentBlock">
  <div class="infoPane">
    ...
    <div class="infoPaneContents">
      <p>The database server stores the content of the gurudonation such as user information, Donation information, and the orders that have been made and so on.</p>
